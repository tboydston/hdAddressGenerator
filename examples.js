...
let bip44Addresses = await bip44.generate(3,0)
 ...
 */
let bip44withSeed = HdAddGen.withSeed(seed,"BTC")

console.log( `\nBIP 44 ( Legacy '1' ) Key Generation with seed` )

// Generate 3 address pairs starting from index 0,
let bip44withSeedAddresses = await bip44withSeed.generate(3,0)
 ...
 */
let bip44withEnc = HdAddGen.withSeed(seed,"BTC",false,44,0,0,"password")
...
// Generate 3 address pairs starting from index 0,
let bip44withEncAddresses = await bip44withEnc.generate(2,0)
 ...
 */
let bip49 = HdAddGen.withMnemonic(mnemonic,"test","BTC",false,49)

console.log( `\nBIP 49 ( Segwit Compatible '3' ) Key Generation` )

// Generate 3 address pairs starting from index 0,
let bip49Addresses = await bip49.generate(3,0)
 ...
 */
let bip84 = HdAddGen.withMnemonic(mnemonic,false,"BTC",true,49)

console.log( `\nBIP 84 ( Segwit bech32 'bc1' ) hardened Key Generation` )

// Generate 3 address pairs starting from index 0,
let bip84Addresses = await bip84.generate(3,0)
 ...
 */
let bip32 = HdAddGen.withMnemonicBIP32(mnemonic,false,"BTC","m/44'/0'/0'",false)

console.log( `\nBIP 32 Key Generation` )

// Generate 3 address pairs starting from index 0,
let bip32Addresses = await bip32.generate(3,0)
 ...
 */
let bip141 = HdAddGen.withMnemonicBIP141(mnemonic,false,"BTC","m/44'/0'/0'","p2wpkh")

console.log( `\nBIP 141 Key Generation` )

// Generate 3 address pairs starting from index 0,
let bip141Addresses = await bip141.generate(3,0,"m/0'/0","p2wpkh")
 ...
 */
let bip44BCH= HdAddGen.withSeed(seed,"BCH")

console.log( `\nBCH Address Conversion` )

// Generate 3 address pairs starting from index 0,
let bip44BCHAddresses = await bip44BCH.generate(3,0)
 ...
 * Using promises
 */
let bip44promise = HdAddGen.withSeed(seed,"BTC")

// Generate 3 address pairs starting from index 0,
bip44promise.generate(3,0).then(function(bip44withSeedAddresses){
